...
2. `npx @sorane/cli@0.2.6 validate --cwd . --json` で検証し、すべての `error` を修正
3. 検索ページがある場合は `npx @sorane/cli@0.2.6 index --cwd . --force`
4. `npx @sorane/cli@0.2.6 build --cwd . --clean` で `dist/` を生成
