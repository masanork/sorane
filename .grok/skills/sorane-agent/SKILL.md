...
Finding: `{ severity: "error"|"warning", category: "okf"|"diagram"|"heading"|"image"|"link"|"table"|"date"|"revision"|"faq"|"glossary"|"reference"|"dataset"|"i18n"|"lang", message, where?, instancePath? }`
