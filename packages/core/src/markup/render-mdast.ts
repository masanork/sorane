...
import type { SanitizeSchemaOptions, TocEntry } from "./sanitize-schema.ts";
...
export function renderMdastToHtml(
  tree: MdastRoot,
  outline: TocEntry[],
  ...
  const processed = rehypePostProcess(raw, outline, sanitizeOpts);
